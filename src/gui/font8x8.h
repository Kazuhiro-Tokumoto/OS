...
/* ==========================================================================
 * font8x8.h  -  GUI 用 8x8 ビットマップフォント (ASCII 0x20-0x7E)
 *
 * tools/make_font.py が Linux カーネルの lib/fonts/font_8x8.c から生成。
 * 手で書き起こしたものではないので、直接編集しないこと。
 *
 * 1 文字 8 バイト。1 バイトが 1 行で、bit7 が左端。
 * ========================================================================== */
#ifndef MYOS_FONT8X8_H
#define MYOS_FONT8X8_H
...
static const unsigned char font8x8[FONT_LAST - FONT_FIRST + 1][8] = {
